...
# Please set region
# Default value is us-east-1 (US East (Northern Virginia) Region)
# You can get region from http://docs.aws.amazon.com/general/latest/gr/rande.html#ec2_region
...
ec2_conn = boto.ec2.connect_to_region(AWS_REGION,aws_access_key_id=AWS_ACCESS_KEY_ID, aws_secret_access_key=AWS_SECRET_ACCESS_KEY)
